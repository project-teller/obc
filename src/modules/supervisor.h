...
/**
 * @brief Class that represents the registration of a task in the task supervisor.
 */
...
public:
     ...
     * @return a token that can be used by the task later when nudging the supervisor
     */
 ...
 */
void checkTasks(uint32_t timestamp = 0);
