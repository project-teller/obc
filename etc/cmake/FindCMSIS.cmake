...
function(cmsis_generate_default_linker_script FAMILY DEVICE CORE)
    ...
    if(${FAMILY} STREQUAL MP1)
        ...
        stm32_get_memory_info(FAMILY ${FAMILY} DEVICE ${DEVICE} CORE ${CORE} RAM_DMA SIZE RAM_DMA_SIZE ORIGIN RAM_DMA_ORIGIN)
