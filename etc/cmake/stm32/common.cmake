...
function(_stm32_generate_file TARGET OUTPUT_EXTENSION OBJCOPY_BFD_OUTPUT PROPERTY)
    ...
    if (PROPERTY)
        set_target_properties(${TARGET} PROPERTIES ${PROPERTY} ${OUTPUT_FILE_NAME})
    endif()
...
function(stm32_generate_binary_file TARGET)
    _stm32_generate_file(${TARGET} "bin" "binary" OUTPUT_BINARY_NAME)
endfunction()
...
function(stm32_get_memory_info)
    set(ARG_OPTIONS FLASH RAM CCRAM STACK HEAP RAM_SHARE RAM_DMA)
    ...
    list(GET STM32_${INFO_FAMILY}_RAM_DMA_SIZES ${TYPE_INDEX} RAM_DMA)
    ...
    elseif(FAMILY STREQUAL "H7")
        stm32h7_get_memory_info(${INFO_DEVICE} ${INFO_TYPE} "${INFO_CORE}" RAM RAM_DMA FLASH_ORIGIN RAM_ORIGIN RAM_DMA_ORIGIN TWO_FLASH_BANKS)
