...
set(STM32_H7_RAM_DMA_SIZES
      0K   0K   0K   0K   0K   0K
    288K   0K   0K   0K   0K   0K   0K   0K
      0K   0K   0K   0K   0K   0K
)
...
function(stm32h7_get_memory_info DEVICE TYPE CORE RAM RAM_DMA FLASH_ORIGIN RAM_ORIGIN RAM_DMA_ORIGIN TWO_FLASH_BANKS)
    ...
    if(CORE STREQUAL "M7")
        ...
        list(GET STM32_H7_RAM_DMA_SIZES ${TYPE_INDEX} RAM_DMA_VALUE)
        set(${RAM} ${RAM_VALUE} PARENT_SCOPE)
        set(${RAM_DMA} ${RAM_DMA_VALUE} PARENT_SCOPE)
        set(${FLASH_ORIGIN} 0x8000000 PARENT_SCOPE)
        set(${RAM_ORIGIN} 0x20000000 PARENT_SCOPE)
        set(${RAM_DMA_ORIGIN} 0x30000000 PARENT_SCOPE)
